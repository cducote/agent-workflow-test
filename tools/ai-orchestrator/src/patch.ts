 ...
 */
export function parseImplementationResponse(response: string): ImplementationResult {
 ...
 * Write files to disk
 */
export function applyFileChanges(changes: FileChange[]): { success: boolean; error?: string } {
  try {
 ...
 */
export function summarizeChanges(result: ImplementationResult): string {
